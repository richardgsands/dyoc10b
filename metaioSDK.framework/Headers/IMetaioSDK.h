...
public:
	...
	/**
	 *  Set an image file as image source. (formerly named: setImageSource)
	 *
	 ...
	 *
	 *	This method is used to set the image source for display and (optical) tracking. Valid color
	 ...
	 *  can be optionally downscaled for tracking (Only available on Android).
	 *
	 ...
	 * \param enableYUVpipeline Whether to capture camera frames in YUV color space (if that is faster)
